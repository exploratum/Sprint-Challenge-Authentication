...
Sessions allow user authentication which helps the server decide which ressources are available to a user

1. What does bcrypt do to help us store passwords in a secure manner.

bcrypt encrypts passwords which can not be read anymore by unwanteds parties 

1. What does bcrypt do to slow down attackers?

Bcrypt can increase the number of consecutive hashing it is doing on the passwords
